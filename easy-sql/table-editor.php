...
<body>
 <div class="container">
	...
	<div class="header">
			<a href="table-editor.php"><img src="images/tables.png" width="50"></a>&nbsp;Table Editor</div>
<?php
					...
					while($dbase=mysql_fetch_row($dblist))
						{	echo "<tr>";
							...
							{	
								...
								echo "<td>";
								?>
								<a href="table-editor.php?dbid=<?php echo $dbase[$i] ?>">
								<?php
...
if(isset($_POST['yes']))
		{	$tbsel=$_POST['del'];
			...
			else echo "<script>alert('Table with name $tbsel dropped.');parent.location.href='table-editor.php?dbid=$z'</script>";
		}
else if(isset($_POST['no']))
			{	
				echo "<script>parent.location.href='table-editor.php?dbid=$z'</script>";
			}
