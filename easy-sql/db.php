...
<body>
 ...
 <div class="container">
	<div class="header">
			<a href="db.php"><img src="images/data3.png" width="50"></a>&nbsp;Database Editor</div>
<?php
...
</br><div></br><img src="images/dbadd.png" height="60" width="60"></div>&nbsp;Create Database: <input type="text" name="dbname" placeholder="Database name">
<input type="submit" name="s" value="Create">&nbsp;<a href="http://dev.mysql.com/doc/refman/5.6/en/create-database.html" target="_blank"><img src="images/help.png" width="20" height="20" alt="help"></a>
</br></br>
<div></br><img src="images/dropdb.png" height="60" width="60"></div>&nbsp;Drop Database: &nbsp;&nbsp;<select name="dbsel">
<?php
...
?>
&nbsp;<a href="http://dev.mysql.com/doc/refman/5.0/en/drop-database.html" target="_blank"><img src="images/help.png" width="20" height="20" alt="help"></a>
<?php
if(isset($_POST['s']))
	{	$dbname=$_POST['dbname'];
...
?>
</br></br><div></br><img src="images/table.svg" height="60" width="60"></div>&nbsp;Show Tables: &nbsp;&nbsp;&nbsp;&nbsp;<select name="dbtable">
<?php
...
?>
&nbsp;<a href="http://dev.mysql.com/doc/refman/5.0/en/show-tables.html" target="_blank"><img src="images/help.png" width="20" height="20" alt="help"></a></div>
<?php
if(isset($_POST['s3']))
