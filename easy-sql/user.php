...
<div class="header">
<a href="user.php"><img src="images/users.png" height="30" width="30"></a>&nbsp;User Management</div></br>
<div id="container2">
 </br><div></br><a href="#op2"><img src="images/listusers.png" width="125"></a></div>
    <div></br><a href="#op1"><img src="images/adduser.png" width="125"></a></div>	
	<div></br><a href="#op3"><img src="images/deluser.png" width="125"></a></div>
	<div></br><a href="#op4"><img src="images/userpass.png" width="125"></a></div>
</div>
<div id="container2">
...
<div class="header">
<a href="user.php"><img src="images/users.png" height="30" width="30"></a>&nbsp;Users List</div></br>
<?php
					...
					while($dbase=mysql_fetch_row($dblist))
						{	echo "<tr>";
							...
							{	
								...
								echo "<td>";
								if($i==0)
								echo "<img src='images/user.png' width=10' height='10'>&nbsp;";
								if($i!=2)
								echo $dbase[$i]."</a></td>";
...
<div class="subheader">
<div class="header"><a href="user.php"><img src="images/adduser.png" height="30" width="30"></a>&nbsp;Add New User</br></div>
...
<div class="subheader">
<div class="header"><a href="user.php"><img src="images/adduser.png" height="30" width="30"></a>&nbsp;Drop User</br></div>
<div class="login">
<table border="1" style="width:100%" align="center">
...
<div class="subheader">
<div class="header"><a href="user.php"><img src="images/userpass.png" height="30" width="30"></a>&nbsp;Change Password</br></div>
<div class="login">
<table border="1" style="width:100%" align="center">
