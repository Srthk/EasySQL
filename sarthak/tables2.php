...
<body>
 <div class="container">
	<div class="header">
			<a href="tables2.php"><img src="addtable.png" width="50"></a>&nbsp;Create Table</div>
<?php
					...
					while($dbase=mysql_fetch_row($dblist))
						{	echo "<tr>";
							...
							{	
								...
								echo "<td>";
								?>
								<a href="tables2.php?dbid=<?php echo $dbase[$i] ?>">
								<?php
...
{	$num2=$_POST['num'];
	...
	if($exe3)
	{
		...
		//header("Location: http://localhost/sarthak/tables2.php?dbid=$z");
		}
